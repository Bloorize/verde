        ...
        <>
          ...
          <Card>
            ...
            <View className="flex-row flex-wrap gap-2">
              <Pressable className="rounded-md border border-brand-200 bg-brand-50 px-3 py-2">
                <Text className="text-xs font-semibold text-brand-700">{t('Reassign')}</Text>
              </Pressable>
              <Pressable onPress={() => completeMutation.mutate()} className="rounded-md bg-brand-600 px-3 py-2">
